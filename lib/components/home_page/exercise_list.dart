  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      ...
      builder: (BuildContext context,
          AsyncSnapshot<List<Exercise>> exercisesSnapshot) {
          ...
          return Padding(
            ...
            child: Row(
              ...
              children: [
                Expanded(
                  child: Container(
                      child: ExerciseColumn(
                          exercisesSnapshot.data,
                          (exercisesSnapshot.data.length / 2).ceil(),
...
class ExerciseColumn extends StatelessWidget {
  ...
  ExerciseColumn(
      this.exercises, this.lenOfColumn, this.startIndex);

  ExerciseListItem getItemForIndex(int index) {
    return ExerciseListItem(
        exercises[startIndex + index], startIndex + index);
  }
                    ...
                    decoration: BoxDecoration(
                        ...
                        gradient: LinearGradient(
                            ...
                            colors: [
                              ...
                              _selected
                                  ? Color.fromRGBO(0xA9, 0xD5, 0x87, 1)
                                  : Color.fromRGBO(0xF0, 0xF0, 0xF0, 1),
                              _selected
                                  ? Color.fromRGBO(0x51, 0xC2, 0xA4, 1)
                                  : Color.fromRGBO(0xF0, 0xF0, 0xF0, 1),
                            ])),
                    child: TextButton(
                      onPressed: () {
                        if (_selected) {
                                              ...
                                              chartData.addAll(List.generate(
                                                  ...
                                                  (int diffIndex) =>
                                                      DataCell(FutureBuilder(
                                                        future: DatabaseDataFiltered
                                                            .getBestInstanceOfExercise(
                                                                _exercise),
                                                        builder: (BuildContext
                                                                cellContext,
                                                            AsyncSnapshot<
                                                                    ExerciseInstance>
                                                                bestInstanceSnapshot) {
                                                          if (bestInstanceSnapshot
                                                                  .data ==
                                                              null) {
                                                            return Text('0');
                                                          } else {
                          ...
                          context.read<ExerciseLogCubit>()
                                .changeSelectedExercise(_indexOfItem, _exercise);
                        }
                      },
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            FutureBuilder(
                              future: DatabaseDataFiltered.getRecentAverage(
                                  _exercise),
                              builder: (BuildContext context,
                                  AsyncSnapshot<ExerciseInstance>
                                      recentAverageSnapshot) {
                                if (recentAverageSnapshot.data == null)
                                  return Text('0x0kg', style: _contentStyle);
                                else
                                  return Text(
                                      ExerciseFormat.instanceToString(
                                          recentAverageSnapshot.data),
                                      style: _contentStyle);
                              },
                            ),
                            !_selected
                            ...
                            !_selected
                                ...
                                : FutureBuilder(
                                    future: DatabaseDataFiltered
                                        .getBestInstanceOfExercise(_exercise),
                                    builder: (BuildContext context,
                                        AsyncSnapshot<ExerciseInstance>
                                            bestInstanceSnapshot) {
